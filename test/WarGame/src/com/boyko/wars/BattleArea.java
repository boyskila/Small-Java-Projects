...
public class BattleArea {
    ...
    public BattleArea(DeckOfCards cardsDeck, Player p1, Player p2) throws IOException {
    ...
    private void play(DeckOfCards cardsDeck, Player p1, Player p2) throws IOException {
        int c = 2;
    ...
    private void createBattle(Player p1, Player p2) throws IOException {
